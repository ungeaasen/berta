  ...
  return (
          <div className="form">
              <div className="formWrapper" >
                  {submit ? (
                  <div className="afterForm"><h3>Takk for din interresse! Berta skaper en positiv feedback-loop mellom medarbeidere og ledelse. Vi gjetter aldri frem løsninger, alle våre leveranser er datadrevet og frie for gjetning og antakelser. 
                  Vi har spurt før vi gir svar.
                    ...
                    <form 
                      ...
                      <div className="formText">
                        ...
                        <p>Ukens Undersøkelse har som formål å stille spørsmål om internkommunikasjon fra et skråblikkperspektiv. Spørsmålene vi stiller, er designet med den hensikt å stille spørsmålene du vanligvis ikke får i en medarbeiderundersøkelse. 
